...
var Tooltip = (function () {
    ...
    Tooltip.prototype.onResize = function (e) {
        this.hide();
    };
    ...
    Tooltip.prototype.tooltipPositioning = function (pos) {
    ...
    Tooltip.prototype.alignTooltip = function () {
        var elementWidth = this.container.getBoundingClientRect().width;
...
__decorate([
    ...
    __metadata("design:paramtypes", [Event]),
    __metadata("design:returntype", void 0)
], Tooltip.prototype, "onResize", null);
Tooltip = __decorate([
    core_1.Directive({
        selector: '[pTooltip]',
        host: {},
